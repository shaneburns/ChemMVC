...
class utils {
    ...
    public static function generateToken($length = 20) : string
    {
        return bin2hex(random_bytes($length));
    }
    
    public static function hashToken($token = null) : string
    {
        if(!is_null($token))
    ...
    public static function classCast(object $start, object $final) : object
    {
